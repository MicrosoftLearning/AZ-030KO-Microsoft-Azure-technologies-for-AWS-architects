...
## AZ-030 과정 및 랩에 대한 참고 사항

이 과정(AZ-030)에서는 다음에 대해 다룹니다. AWS 아키텍처를 위한 Microsoft Azure 기술은 숙련된 AWS 아키텍처를 위한 4일 간의 과정에 맞게 조정된 AZ-303 과정 자료의 하위 집합입니다. 이 과정에서는 미니 랩(폴더/지침/미니 랩에 위치)을 통해 학생들에게 Azure Portal 및 Cloud Shell 환경과의 상호 작용에 대한 간단하고 자주 사용되는 실습을 수행합니다.

추가 학습을 촉진하기 위해 학생들은 이 과정을 완료한 후, 각각 60~120분씩 진행되는 더 긴 시간의 [AZ-303 랩](https://github.com/MicrosoftLearning/AZ-303KO-Microsoft-Azure-Architect-Technologies)을 완료하는 것이 권장됩니다.

## Microsoft의 역할

- 이 과정을 지원하려면 해당 과정에 사용된 Azure 서비스를 최신 상태로 유지하기 위해 과정 콘텐츠를 자주 업데이트해야 합니다.  또한 GitHub에 미니 랩 지침을 게시하여 과정 작성자와 MCT 간의 공개적인 기고를 지원함으로써 Azure 플랫폼의 변경에 따라 콘텐츠를 최신 상태로 유지합니다.
